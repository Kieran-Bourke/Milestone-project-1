...
This website is designed to inform aspiring guitar players on the basics of guitar. The website will take them through the basics of each type of guitar aswell as point them towards external learning rescources.  
...
###  First time visitor goals
    1. To easily understand the purpuse of the website.
...
### Returning Visitor goals
    ...
    3. To feel comfotable using the contact form if anything is not working. 

### Frequent user goals
    1.To be able to quickly navigate to the pages they want.
    2.To feel comfortable with the website and its features.
    3.To understand the differences in guitar types and feel confident in recomending the site.

## Design

###  colour scheme
- colours used for background orange (#CE4027) and dark blue(#222844), an off white colour was used for the text (#f4f4f4)

### Typography
-   Open sans was used throught the website, with sand serif used as a back up incase open sans will not load.
...
## Frameworks, Libraries & Programs Used 
    ...
    3. Git:
        Git was used to Update and accses versions using Gitpod to push to GitHub.
    4. GitHub:
        GitHub is used to store the code for the project.
    5. Balsamiq:
        Balsamiq was used to create the wireframes for the project.
    6. jquery 3.2.1 
        jquery was used to make the collapsable navigation.
...
- #### First Time Visitor Goals 
  ...
  1. To easily understand the purpuse of the website.
        ...
        1. Upon entering the site the user is greated by the title Simply Guitar a naviagation bar and a large image of a an acoustic guitar.
        2. The large image of the acoustic guitar aswell as the brief acoustic guitar overview makes it easy to understand what the site will be like. 
        3. If the user scrolls down they will see a Learn more button aswell as 2 other sections for different guitars. 

  2. To be able to easily navigate between pages.

        1. When entering the site the user is greated with a visiable navigation bar which is consistent across pages.
...
- ####  Returning Visitor Goals
    ...
    1. To be able to quickly navigate to the pages they want.
        ...
        3.  The user has accese to all pages from all pages. 

  2. To feel comfortable with the website and its features.

        1. The page feautres are consistent across the website helping to get used to them quickly.
        2. The website feautres are kept simple and similar to other sites as to not throw people off.
        3. The amount of website features are kept low but usefull as to not overwelm the user.
...
- #### Frequent Visitor Goals
  ...
  3. To understand the differences in guitar types and feel confident in recomending the site.
        ...
        3. The website uses audio to further add to the understanding of the differeneces between guitar types.(Audio will be added soon)

 ## Known Bugs
    - Tabs being cut of on mobile - possible soloution is to segemnt the images to help it stack for mobile.
	- Audio not being correct - this can be fixed by either gaining accese to the songs without copyright or by produceing a cover of the song.
	- The contact form currently dosent go anywhere - this can be fixed by adding a data base to connect it to. 
	- The navigation links in the header are not centerd.
	- The social icons sit incorectly while on mobile devices.
...
* Bootstrap4: The Boostrap libary was used throughout the project to make the site responsive.
* StackOverflow was used to multiple times througout the project to help solve different problems.   
    ...
    3. hamburgr nav [StackOverFlow post](https://stackoverflow.com/questions/45756307/bootstrap-4-toggle-button-not-working/45756392)
